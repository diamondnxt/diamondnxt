...
// Route to create an applicant based on id and levelname
app.post('/create-access-token', async (req, res) => {
    try {
        // Extract id and levelname from the request body
        ...
        if (response) {
            ...
            res.status(500).json({ error: 'No response from Sumsub API' });
        }
    } catch (error) {
